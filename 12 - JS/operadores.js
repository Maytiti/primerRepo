...
let suma = "" + numero3 + numero4;  //Concatena ya que "7" es un string 


console.log(suma);

//Concat es un metodo que solo es para los strings. Es decir necesitamos que al menos una de las variables sea un string (es un metodo de cadena)
...
let nombre = "Fernanda";
let saludin = `Hola ${nombre}, que gusto verte!`; //${} noo permite usar comillas y se usan los ``  convertirlos encaracteres

console.log(saludo);

//Escape de comillas simples (alt 39)
//escape de colillas se refiere a que no puede poner las mismas comillas adentro y afuera 
...
//Igualdad estricta === verifica el mismo valor, pero tambien el mismo tipo de dato uno es string y otro num 
let estIgualdad = num === num1;
console.log(estIgualdad);

//Estricta desigualdad !==  dice si son diferentes tipos de datos 
